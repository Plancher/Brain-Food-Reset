       ...
       {/* Social Proof */}
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-700 mb-4 italic">
                "Ich dachte, ich hätte keine Zeit für so etwas. Aber die 30 Minuten pro Tag waren mein Anker – weniger Stress, mehr Energie, und endlich kein emotionales Snacken mehr."
              </p>
              <div className="text-sm">
                <p className="font-medium text-gray-900">Anna K.</p>
                <p className="text-gray-500">Projektmanagerin, 29 Jahre</p>
              </div>
            </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "Ich habe jedes Diätprogramm probiert – nichts hat funktioniert. Erst durch den Reset habe ich verstanden, warum ich esse. Das hat wirklich alles verändert."
                </p>
                <div className="text-sm">
                  <p className="font-medium text-gray-900">Jonas F.</p>
                  <p className="text-gray-500">Softwareentwickler, 32 Jahre</p>
                </div>
              </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="text-sm">
                <p className="font-medium text-gray-900">Marcus S.</p>
                <p className="text-gray-500">Masterstudent, 26 Jahre</p>
              </div>
            </div>
          </div>
        </div>
